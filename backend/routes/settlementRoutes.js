...
const { addSettlement, getSettlements, generateUPIQRCode, addRecurringContribution, paymentReminder, getMyRecurringContributions, updateRecurringContribution, deleteRecurringContribution } = require('../controllers/settlementController');
